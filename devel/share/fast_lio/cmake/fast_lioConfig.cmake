...
if("TRUE" STREQUAL "TRUE")
  set(fast_lio_SOURCE_PREFIX /home/wbb/catkin_ws_3d/src/FAST_LIO)
  set(fast_lio_DEVEL_PREFIX /home/wbb/catkin_ws_3d/devel)
  set(fast_lio_INSTALL_PREFIX "")
  set(fast_lio_PREFIX ${fast_lio_DEVEL_PREFIX})
else()
  set(fast_lio_SOURCE_PREFIX "")
  set(fast_lio_DEVEL_PREFIX "")
  set(fast_lio_INSTALL_PREFIX /home/wbb/catkin_ws_3d/install)
...
if(NOT "/home/wbb/catkin_ws_3d/devel/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fast_lio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wbb/catkin_ws_3d/src/FAST_LIO/${idir}'.  ${_report}")
    endif()
